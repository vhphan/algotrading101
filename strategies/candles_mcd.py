"""
Strategy uses multiple candles patterns & indicators:

'CDLENGULFING', 'CDLMORNINGSTAR', 'CDLEVENINGSTAR', 'CDLHAMMER', 'CDLSHOOTINGSTAR'
'Ichimoku',
'MCD'
...
class MyStrategy(GenericStrategy):
    ...
    def __init__(self, **kwargs):
        ...
        for i, d in enumerate(self.datas):
            ...
            # MACD indicators
            self.indicators[d]['macd'] = bt.indicators.MACDHisto()
            self.indicators[d]['macd_line'] = self.indicators[d]['macd'].macd
